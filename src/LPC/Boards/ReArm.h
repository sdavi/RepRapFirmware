...
constexpr PinEntry PinTable_Rearm[] =
{
    ...
    //Thermistors
    {P0_23, PinCapability::ainrw, "e0temp,t0,P0.23"},        //Ext0 Therm
    {P0_24, PinCapability::ainrw, "bedtemp,t1,P0.24"},        //Bed Therm
    {P0_25, PinCapability::ainrw, "e1temp,t2,P0.25"},        //Ext1 Therm
    
    //Endstops (although they are labeled x- and x+ on the - and + get stripped out in RRF so we will use i.e. xmin/xmax
    {P1_24, PinCapability::rwpwm, "xstop,d3,P1.24"},
    {P1_25, PinCapability::rwpwm, "xstopmax,d2,P1.25"},
    {P1_26, PinCapability::rwpwm, "ystop,d14,P1.26"},
    {P1_27, PinCapability::rwpwm, "ystopmax,d15,P1.27"},
    {P1_29, PinCapability::rwpwm, "zstop,d18,P1.29"},
    {P1_28, PinCapability::rwpwm, "zstopmax,d19,P1.28"},

    //Heaters and Fans (Mosfets)
    {P2_7, PinCapability::rwpwm, "bed,d8,P2.7"  },            //HB Mosfet
    {P2_4, PinCapability::rwpwm, "e1heat,d9,P2.4" },             //HE2 Mosfet
    {P2_5, PinCapability::rwpwm, "e0heat,d10,P2.5" },            //HE1 Mosfet

    //Servos (only max of 3 servos can be configured_
    {P1_20, PinCapability::rwpwm, "servo0,d11,P1.20"},     //PWM1[2]
    {P1_21, PinCapability::rwpwm, "servo1,d6,P1.21"},      //PWM1[3]
    {P1_19, PinCapability::rwpwm, "servo2,d5,P1.19"},
    {P1_18, PinCapability::rwpwm, "servo3,d4,P1.18"},      //PWM1[1]
    ...
    //Ramps I2C Header
    {P0_0, PinCapability::rwpwm, "sca,20,P0.0"},        //labelled on board as 20
    {P0_1, PinCapability::rwpwm, "scl,21,P0.1"},        //labelled on board as 21
    ...
    //P0_16, (Overlaps  Aux4)
    {P1_23, PinCapability::rwpwm,"d53,P1.23"},               //PWM1[4]
    {P2_11, PinCapability::rwpwm,"d35,P2.11"},
    {P1_31, PinCapability::rwpwm,"d49,P1.31"},
    //P0_18, MOSI (overlaps Aux4/Aux3)
    {P2_6,  PinCapability::rwpwm,"d59,P2.6"},               //(overlaps Aux2)
    //P0_17, MISO (overlaps Aux3)
    {P3_25, PinCapability::rwpwm,"d33,P3.25"},               //PWM1[2]
    {P3_26, PinCapability::rwpwm,"d31,P3.26"},               //PWM1[3]
